...
# python3 calc_emission_inference.py -device cpu -interface pipeline -task_type fill-mask
# python3 calc_emission_inference.py -device cpu -interface manually-just-inference -task_type fill-mask
# python3 calc_emission_inference.py -device cpu -interface manually-just-inference-extract -task_type fill-mask
# python3 calc_emission_inference.py -device cpu -interface manually-just-extract -task_type fill-mask
python3 calc_emission_inference.py -device cpu -interface manually -task_type fill-mask
python3 calc_emission_inference.py -device cpu -interface manually-just-data -task_type fill-mask
